...
void ecn2_mirvar(_MIPD_ ecn2* q){
    zzn2_mirvar(_MIPP_ &(q->x));
    zzn2_mirvar(_MIPP_ &(q->y));
    zzn2_mirvar(_MIPP_ &(q->z));
}
void ecn2_kill(_MIPD_ ecn2* q){
    zzn2_kill(_MIPP_ &(q->x));
    zzn2_kill(_MIPP_ &(q->y));
    zzn2_kill(_MIPP_ &(q->z));
}
